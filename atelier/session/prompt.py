...
from atelier.memory import Decision, MemoryRecord
from atelier.util.ulid import new_stage_id
...
def generate_prompt(run_id: str, role: str, target_agent: str) -> str:
    ...
    compiled = _compile_session_packet(
        run_id=run_id,
        objective=(
            f"Generate a fresh {normalized_role} prompt for this Atelier run. "
