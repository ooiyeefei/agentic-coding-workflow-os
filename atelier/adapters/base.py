...
from atelier.memory import Decision, MemoryRecord, RejectedAlternative, ReviewFinding
from atelier.util.ulid import new_run_id, new_stage_id
...
class ToolAdapter(ABC):
    ...
    def _build_packet(
        ...
        *,
        ...
        parts = [
            heading,
            f"Resume work as the `{role}` agent using context transferred by Atelier.",
            "",
    ...
    def _render_run_state(self, run_id: str) -> str:
        run_path = self.repo_root / ".atelier" / "runs" / run_id
