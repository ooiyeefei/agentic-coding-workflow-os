...
5. `from atelier.llm.capabilities import load_capability_manifests`
6. `print([manifest.model for manifest in load_capability_manifests(Path('.atelier/defaults/models'))])`
7. `PY`
