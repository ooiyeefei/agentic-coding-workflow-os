...
- [X] T002 Create the adapter package skeleton in `atelier/adapters/`
...
- [X] T004 Implement manifest schema and loading helpers in `atelier/adapters/base.py`
- [X] T005 Implement shared transcript normalization and heuristic extraction helpers in `atelier/adapters/base.py`
- [X] T006 Implement shared run-state and ADR summary helpers for packet formatting in `atelier/adapters/base.py`
...
**Independent Test**: Fixture transcripts produce expected `Decision` counts and can be written to `.atelier/memory/`.
...
- [X] T010 [US1] Implement Claude Code transcript ingestion in `atelier/adapters/claude_code.py`
- [X] T011 [US1] Implement Codex transcript ingestion in `atelier/adapters/codex.py`
- [X] T012 [US1] Implement generic markdown transcript ingestion in `atelier/adapters/generic.py`
...
- [X] T014 [P] [US2] Add Claude Code packet formatting in `atelier/adapters/claude_code.py`
- [X] T015 [P] [US2] Add Codex packet formatting in `atelier/adapters/codex.py`
- [X] T016 [P] [US2] Add generic packet formatting in `atelier/adapters/generic.py`
...
- [X] T018 [P] [US3] Add Claude Code manifest in `atelier/adapters/manifests/claude-code.yaml`
- [X] T019 [P] [US3] Add Codex manifest in `atelier/adapters/manifests/codex.yaml`
- [X] T020 [US3] Implement detection logic and package exports in `atelier/adapters/__init__.py`
