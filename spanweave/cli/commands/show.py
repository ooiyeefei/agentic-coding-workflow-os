...
from spanweave.cli.commands.run import get_repo_from_context, load_run_record_for_cli
from spanweave.cli.formatters import (
    build_help_epilog,
    echo_json,
    render_key_values,
    render_stage_tree,
...
@click.command(
    ...
    epilog=build_help_epilog(
        notes=(
            "This reads the stored run metadata and stage tree under .spanweave/runs/<run_id>/.",
        ),
        examples=(
            "spanweave run show run_01ARZ3NDEKTSV4RRFFQ69G5FAV --repo .",
            "spanweave run show run_01ARZ3NDEKTSV4RRFFQ69G5FAV --repo . --json",
        ),
    ),
)
