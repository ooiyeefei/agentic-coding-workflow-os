...
@click.command(
    ...
    epilog=build_help_epilog(
        ...
        examples=(
            ...
            "spanweave cleanup run_01ARZ3NDEKTSV4RRFFQ69G5FAV --repo . --yes --json",
        ),
    ),
)
...
def cleanup_command(run_id: str, repo: Path, yes: bool, json_output: bool) -> None:
    ...
    from spanweave.git.cleanup import cleanup_run_worktrees
    from spanweave.git.errors import WorktreeError
