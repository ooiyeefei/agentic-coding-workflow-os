...
@click.group(
    ...
    epilog=build_help_epilog(
        notes=(
            ...
            "Rule library lives at .spanweave/defaults/feedback_rules/*.yaml; override with "
            "--rules-dir.",
        ),
        examples=(
            "spanweave skill_feedback derive --entry path/to/outcome.json",
            "spanweave skill_feedback derive --entry outcome.json --skill-file SKILL.md --apply",
            "spanweave skill_feedback list-rules --json",
        ),
    ),
)
...
@skill_feedback_group.command(
    ...
    epilog=build_help_epilog(
        ...
        examples=(
            "spanweave skill_feedback derive --entry outcome.json",
            "spanweave skill_feedback derive --entry outcome.json --skill-file SKILL.md",
            "spanweave skill_feedback derive --entry outcome.json --skill-file SKILL.md --apply",
            "spanweave skill_feedback derive --entry outcome.json --json",
        ),
    ),
)
@click.option(
...
@skill_feedback_group.command(
    ...
    epilog=build_help_epilog(
        ...
        examples=(
            "spanweave skill_feedback list-rules",
            "spanweave skill_feedback list-rules --rules-dir custom/feedback_rules",
            "spanweave skill_feedback list-rules --json",
        ),
    ),
)
